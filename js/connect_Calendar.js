// frontend/js/connect_Calendar.js
        ...
        loginForm.addEventListener('submit', async function (event) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    window.location.href = 'UserCalendar.html'; // Adjust as necessary (u need to create a special app interface for a specific user)
                } else {
